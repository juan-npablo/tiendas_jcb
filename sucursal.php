...
Módulo: Sucursal
Descripción: Trae la información de la tabla sucursal, ordenando los datos por el nombre alfabético de cada sucursal.
             De igual manera, en este formulario se encuentra la opción de editar y/o eliminar el registro ingresado.
*/	
  include("conexion.php");
  
  $seleccionarRegistros = "SELECT * FROM sucursal ORDER BY nombre_sucursal";
        ...
        <div class="container-md">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="sucursal.php">Sucursal</a>
              </li>
              <li class="nav-item">
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="card border border-dark">
            ...
            <div class="card-body">
              <form action="Insercion\insertarSucursal.php" method="POST" id="f1" name="f1">
                <div class="mb-3">
                  <label for="id" class="form-label">ID Sucursal</label>
                  <input type="number" class="form-control" name="id_sucursal" id="id" required>
                </div>
                <div class="mb-3">
                  <label for="nombre" class="form-label">Nombre de la Sucursal</label>
                  <input type="text" class="form-control" name="nombre_sucursal" id="nombre" required>
                </div>
                <div class="mb-3">
                  <label for="calle" class="form-label">Calle</label>
                  <input type="text" class="form-control" name="calle_sucursal" id="calle" required>
                </div>
                <div class="mb-3">
                ...
                <input type="submit" class="btn btn-primary" value="Agregar sucursal">
                ...
                <?php
                  while($mostrarRegistros = mysqli_fetch_array($resultadoSeleccion)){
                    echo "<tr>";
                      ...
                      echo "<td>" .$mostrarRegistros['nombre_sucursal']. "</td>";
                      echo "<td>" .$mostrarRegistros['calle_sucursal']. "</td>";
                      echo "<td>" .$mostrarRegistros['ciudad_sucursal']. "</td>";
                      echo "<td>" .$mostrarRegistros['departamento_sucursal']. "</td>";
                ?>
                    <td><a href="Update\actualizarSucursal.php?id=<?php echo $mostrarRegistros['id_sucursal'] ?>" class="btn btn-info">Editar</a></td>
                    <td><a href="Delete\deleteSucursal.php?id=<?php echo $mostrarRegistros['id_sucursal'] ?>" class="btn btn-danger">Eliminar</a></td>
                <?php
                  }
                ?>
                </tr>
