        ...
        <div class="container-md">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="suministra.php">Suministra</a>
              </li>
              <li class="nav-item">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card border border-dark">
              ...
              <div class="card-body">
                <form action="Insercion\insertarSuministra.php" method="POST">
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <br>
                    <select name="id_proveedor" class="form-select" aria-label="Default select example" required>
                      <option selected></option>
                        <?php	
                          $SQL ="SELECT * FROM proveedores";
                          $buscar_proveedor = $conn -> query($SQL);
                          while($mostrar= $buscar_proveedor -> fetch_array()){
                            echo "<option value= '".$mostrar['id_proveedor']."'>".$mostrar['id_proveedor']." - ".$mostrar['nombre_proveedor']."</option>";
                          }
                        ?>
                    </select>
                  </div>
                  <div class="mb-3">
                    <label for="id" class="form-label">Fecha Suministro</label>
                    <input type="date" class="form-control" name="fechaSuministro" id="id" required>
                  </div>
                  <div class="mb-3">
                    <label for="id" class="form-label">Unidades suministradas</label>
                    <input type="number" class="form-control" name="unidades" id="id" required>
                  </div>
                  <input type="submit" class="btn btn-primary" value="Agregar suministro">
                    ...
                    <?php
                      while($mostrarRegistros = mysqli_fetch_array($resultadoSeleccion)){
                        echo "<tr>";
                          ...
                          echo "<td>" .$mostrarRegistros['fechaSuministro']. "</td>";
                          echo "<td>" .$mostrarRegistros['unidades']. "</td>";
                    ?>
                        <td><a href="Update\actualizarSuministra.php?id_producto=<?php echo $mostrarRegistros['id_producto']?>&id_proveedor=<?php echo $mostrarRegistros['id_proveedor']?>&fechaSuministro=<?php echo $mostrarRegistros['fechaSuministro']?>" class="btn btn-info">Editar</a></td>
                        <td><a href="Delete\deleteSuministra.php?id_producto=<?php echo $mostrarRegistros['id_producto']?>&id_proveedor=<?php echo $mostrarRegistros['id_proveedor']?>&fechaSuministro=<?php echo $mostrarRegistros['fechaSuministro']?>" class="btn btn-danger">Eliminar</a></td>
                    <?php
                      }
                    ?>
                    </tr>
