...
Módulo: Empleados 
Descripción: Trae la información de la tabla empleados, ordenando los datos por el nombre alfabético de cada empleado.
             De igual manera, en este formulario se encuentra la opción de editar y/o eliminar el registro ingresado.
*/	
  include("conexion.php");
  
  $seleccionarRegistros = "SELECT * FROM empleados ORDER BY nombre_empleado";
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card border border-dark">
              ...
              <div class="card-body">
                <form action="Insercion\insertarEmpleado.php" method="POST" id="f1" name="f1">
                <div class="row">
                  <div class="col-4">
                    <div class="mb-3">
                      <label for="id" class="form-label">ID Empleado</label>
                      <input type="number" class="form-control" name="id_empleado" id="id" required>
                    </div>
                    <div class="mb-3">
                      <label for="nombre" class="form-label">Nombre</label>
                      <input type="text" class="form-control" name="nombre_empleado" id="nombre" required>
                    </div>
                    <div class="mb-3">
                      <label for="Apellido" class="form-label">Apellido</label>
                      <input type="text" class="form-control" name="apellidos_empleado" id="Apellidos" required>
                    </div>
                  ...
                  <div class="col-4">
                    <div class="mb-3">
                      ...
                      <input type="date" class="form-control" name="fechaNacimiento_empleado" id="fechaNacimiento" required>
                    </div>
                    <div class="mb-3">
                      <label for="telefono" class="form-label">Telefono</label>
                      <input type="number" class="form-control" name="telefono_empleado" id="telefono" required>
                    </div>
                    <div class="mb-3">
                      <label for="calle" class="form-label">Calle</label>
                      <input type="text" class="form-control" name="calle_empleado" id="calle" required>
                    </div>
                  </div>
                  <div class="col-4">
                    <div class="mb-3">
            ...
            <tbody>
              ...
              <?php
                while($mostrarRegistros = mysqli_fetch_array($resultadoSeleccion)){
                  echo "<tr>";
                    echo "<td>" .$mostrarRegistros['id_empleado']. "</td>";
                    echo "<td>" .$mostrarRegistros['nombre_empleado']. "</td>";
                    echo "<td>" .$mostrarRegistros['apellidos_empleado']. "</td>";
                    echo "<td>" .$mostrarRegistros['fechaNacimiento_empleado']. "</td>";
                    echo "<td>" .$mostrarRegistros['calle_empleado']. "</td>";
                    echo "<td>" .$mostrarRegistros['ciudad_empleado']. "</td>";
                    echo "<td>" .$mostrarRegistros['departamento_empleado']. "</td>";
                    echo "<td>" .$mostrarRegistros['telefono_empleado']. "</td>";
                    echo "<td>" .$mostrarRegistros['id_sucursal']. "</td>";
              ?>
                  <td><a href="Update\actualizarEmpleado.php?id=<?php echo $mostrarRegistros['id_empleado'] ?>" class="btn btn-info">Editar</a></td>
                  <td><a href="Delete\deleteEmpleado.php?id=<?php echo $mostrarRegistros['id_empleado'] ?>" class="btn btn-danger">Eliminar</a></td>
              <?php
                }
              ?>
              </tr>
